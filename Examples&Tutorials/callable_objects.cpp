...
int main()
{
  ...
  struct Cfoo { inline operator int  ()  { return 7; } };       // some struct without operator(), yet you may call the constructor - it always exists!
...
//  UF pfoo2 = dfoo;    // -but their types must match.
  UF pfoo3 = ai;        // +lambda may be assigned to function pointer,
  UF pfoo4 = ai1;       // +any lambda with matching type.
//  UF pfoo5 = ofoo;    // -no other objects may be assigned to function pointer.
